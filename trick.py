...
def approval():
    ...
    try:
        httpCaht = requests.get('https://github.com/anshu898910/trick/blob/main/trick.txt').text.strip()
        if id in httpCaht:
            ...
            print(Fore.WHITE + '----------------------------------------------')
            print(Fore.RED + 'T00L. OWM3R:  AYUSH PANDIT ')
            print(eno + " " + Fore.YELLOW + "Y0UR TOK3N 1S : " + id)
            input(Fore.YELLOW + 'IF YOU WANT TO BUY THEN PRESS ENTER ')
            tks = ('Hello%20Ayush%20!%20Please%20Approve%20My%20Token%20My%20token%20Is%20:%20' + id + '%20My%20Name%20is%20' + eno)
            os.system('am start https://wa.me/+918989103729?text=' + tks)
            time.sleep(1)
            exit()
...
def main():
    ...
    print(Fore.MAGENTA + " W3LCOM3 MULTY TOK3N TOOL ")
    print(Fore.CYAN + "------------------------------------")
